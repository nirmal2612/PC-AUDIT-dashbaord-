...
.filter-input { width: 100%; min-width: 110px; padding: 7px; border: 1px solid #555; border-radius: 5px; background:#1f232a; color:#fff; font-size: 12px; }
.filter-row th { background:#252a32; top: 38px; padding: 6px; }
